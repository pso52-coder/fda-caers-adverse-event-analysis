...
**통계적 이상치 탐지가 아닙니다.** 탐색적 분석에서 통상적인 시각적 선별이며, 이 저장소의 사후 검증에서도 두 브랜드는 IQR·robust z 기준을 넘지 않습니다([상세](docs/reproduction_audit.md#5-브랜드-분석-감사)).
...
| 구분 | 내용 |
|---|---|
| **팀 프로젝트** | 운영 총괄(일정·역할 조율·튜터 커뮤니케이션·제출물 점검), **브랜드 사례 심층 분석**, 발표회 발표 |
| **팀 공동** | 데이터 전처리, EDA 및 시각화, 인사이트 해석, 발표 자료 제작 — 각각 다른 팀원 담당 |
| **본 저장소** | 전 과정 재현·감사·개선안 설계 (개인 단독) |

5인 팀 · 2026.04.02–2026.04.08

브랜드 사례 심층 분석은 팀 분석 단계 종료 후 개인적으로 추가 진행한 작업이며, 역할표에는 반영되지 않았습니다. 상세는 [`docs/role_and_ownership.md`](docs/role_and_ownership.md)를 참고하세요.
...
| 파일 | 내용 |
|---|---|
| [`reproduction_audit.md`](docs/reproduction_audit.md) | 감사 보고서 — 데이터 단위, 전처리, 심각도 정의, 산업군, 브랜드, 외부 검증 |
| [`discrepancy_report.md`](docs/discrepancy_report.md) | 발표 자료와 재현 결과의 불일치 7건 |
| [`role_and_ownership.md`](docs/role_and_ownership.md) | 담당 범위 판단 근거와 공개 제외 항목 |
